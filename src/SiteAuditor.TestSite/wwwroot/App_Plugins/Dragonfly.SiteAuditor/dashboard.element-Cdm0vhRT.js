...
class p {
  static ping(e) {
    return (e?.client ?? l).get({
      ...
      url: "/umbraco/dragonflysiteauditor/api/v1/ping",
      ...e
    });
  }
  static whatsMyName(e) {
    return (e?.client ?? l).get({
      ...
      url: "/umbraco/dragonflysiteauditor/api/v1/whatsMyName",
      ...e
    });
  }
  static whatsTheTimeMrWolf(e) {
    return (e?.client ?? l).get({
      ...
      url: "/umbraco/dragonflysiteauditor/api/v1/whatsTheTimeMrWolf",
      ...e
    });
  }
  static whoAmI(e) {
    return (e?.client ?? l).get({
      ...
      url: "/umbraco/dragonflysiteauditor/api/v1/whoAmI",
      ...e
    });
  }
}
var U = Object.defineProperty, E = Object.getOwnPropertyDescriptor, b = (t) => {
  ...
  for (var s = a > 1 ? void 0 : a ? E(e, r) : e, m = t.length - 1, d; m >= 0; m--)
    (d = t[m]) && (s = (a ? d(e, r, s) : d(s)) || s);
...
//# sourceMappingURL=dashboard.element-Cdm0vhRT.js.map
